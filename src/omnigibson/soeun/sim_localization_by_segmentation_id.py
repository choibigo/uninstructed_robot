...
save_root_path = r"/home/starry/workspaces/dw_workspace/git/uninstructed_robot/src/omnigibson/soeun/image_frames/frames_240219/"
                ...
                if TBLR_frame_check(segment, sensor_image_height, sensor_image_width):
                    ...
                    if seg_count > 0:
                        ...
                        if f'{segment_id_list[idx]}' in OBJECT_DATA:
                            ...
                            OBJECT_DATA[f'{segment_id_list[idx]}'] = {'label' : OBJECT_LABEL_GROUNDTRUTH[f'{segment_id_list[idx]}']['label'],
